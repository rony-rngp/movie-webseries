...
@section('content')
    ...
    <div class="center-text">
        <img src="{{ url('backend/upload/category/slider/'.$subcategory->category->image) }}" class="img-fluid" alt="Responsive image">
    </div><!-- slider -->
    ...
    <section class="blog-area section">
        <div class="container">
            <h4 class="text-left">
                ...
                <i> / <a style="color: blue" href="{{ route('subcategory',[$subcategory->category->id, $subcategory->category->slug]) }}"><u>{{ $subcategory->category->name }}</u></a></i>
