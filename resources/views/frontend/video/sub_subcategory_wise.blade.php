...
@section('content')
    ...
    <div class="center-text">
        <img src="{{ url('backend/upload/category/slider/'.$sub_subcategory->subcategory->category->image) }}" class="img-fluid" alt="Responsive image">
    </div><!-- slider -->
    ...
    <section class="blog-area section">
        <div class="container">
            <h4 class="text-left">
                ...
                <i> / <a style="color: blue" href="{{ route('subcategory',[$sub_subcategory->subcategory->category->id, $sub_subcategory->subcategory->category->slug]) }}"><u>{{ $sub_subcategory->subcategory->category->name }}</u></a></i>
                <i> / <a style="color: blue" href="{{ route('sub.subcategory',[$sub_subcategory->subcategory->id, $sub_subcategory->subcategory->slug]) }}"><u>{{ $sub_subcategory->subcategory->name }}</u></a></i>
                <i> / {{ $sub_subcategory->name }}</i>
            </h4><br><br>
            <div class="row">
